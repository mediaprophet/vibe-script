 ...
 * @returns {any}
 */
export function apply_structural_edits(src, edits_json) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(edits_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.apply_structural_edits(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {string}
 */
export function ast_schema_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.ast_schema_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {any}
 */
export function check_cell_src(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.check_cell_src(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function check_program_src(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.check_program_src(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function compile_cell_bytecode(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile_cell_bytecode(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function decode_and_run(bytes) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_and_run(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function diagnose_src(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.diagnose_src(ptr0, len0);
    return ret;
}
 ...
 * @returns {string}
 */
export function diagnostic_schema_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.diagnostic_schema_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function ebnf_grammar() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.ebnf_grammar();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {any}
 */
export function encode_cell_bytecode(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.encode_cell_bytecode(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function eval_cell_json(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.eval_cell_json(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function eval_cell_src(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.eval_cell_src(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function eval_program_src(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.eval_program_src(ptr0, len0);
    return ret;
}
 ...
 * @returns {string}
 */
export function language_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.language_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {any}
 */
export function parse_cell_src(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_cell_src(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function parse_program_src(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_program_src(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function project_source(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.project_source(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function run_cell_bytecode(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_cell_bytecode(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function run_program_bytecode(src, fn_name, args) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    const ret = wasm.run_program_bytecode(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vibe_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
